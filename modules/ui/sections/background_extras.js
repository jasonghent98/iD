...
export function uiSectionBackgroundExtras(context) {
    ...
    .content(selection => {
        ...
        minimapLabelEnter
            .append('span')
            .call(t.apply('background.minimap.description'));
        ...
        panelLabelEnter
            .append('span')
            .call(t.apply('background.panel.description'));
        ...
        locPanelLabelEnter
            .append('span')
            .call(t.apply('background.location_panel.description'));
        ...
        selection.selectAll('.imagery-faq')
            ...
            .append('span')
            .call(t.apply('background.imagery_problem_faq'));
    });
}
